...
const PRICING_DATA = [
  {
    ...
    desc: "Biometric-grade identity verification cross-referencing global databases and Emirates ID authenticity. Essential for preventing fraud at the first touchpoint.",
  ...
  },
  {
    ...
    desc: "Comprehensive UAE police clearance or global equivalent background verification conducted by local legal teams covering all relevant courts.",
  ...
  },
  {
    ...
    desc: "AI-driven screening for public behavioral red flags, hate speech, or content that contradicts corporate values and UAE cultural standards.",
...
export default function UAEBGPricingClient() {
