        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 48, paddingBottom: 48, borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <span style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontWeight: 900, fontSize: 22, letterSpacing: "-0.03em" }}>Wirestork<span style={{ color: BLUE }}>.</span></span>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr", gap: 40, marginBottom: 48 }}>
            {[
              { heading: "Company", links: ["About","Our technology","Career","Become a Partner","Join our attorney network","Reach Us"] },
              { heading: "Services", links: ["Travel Ban Check","Police and Courts","Labour Ban Check","Immigration Check","Travel Ban Appeal","Lawyer on call"] },
              { heading: "For Business", links: ["Background Verification","Debt Collection","Contract review","Company Formations","Vendor Verification","Client Verification"] },
              { heading: "Legal", links: ["Privacy Policy","Data retention Policy","Terms of service","Refund Policy","Partner Agreement"] },
              ...
              <div key={col.heading}>
                ...
                {col.heading === "Security" ? (
                  <div style={{ fontSize: 12, color: "rgba(255,255,255,0.3)", lineHeight: 1.7 }}>We take security and privacy seriously. Learn more about security and compliance at Wirestork.</div>
                ) : (
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {col.links.map((l) => <span key={l} style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", cursor: "pointer" }}>{l}</span>)}
                  </div>
                )}
              </div>
            ))}
          ...
          <div style={{ paddingTop: 32, borderTop: "1px solid rgba(255,255,255,0.05)" }}>
            <p style={{ fontSize: 12, color: "rgba(255,255,255,0.25)", lineHeight: 1.8, marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
              ...
              <div style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontWeight: 900, fontSize: 18, color: "rgba(255,255,255,0.25)", letterSpacing: "-0.02em" }}>Simplifying Legal Intelligence</div>
            </div>
          </div>
        </div>
      </footer>
